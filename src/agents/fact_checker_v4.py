"""Fact-Checker Agent v0.4.0 - Tavily evidence gatherer."""
...
from src.utils.tavily_client import get_tavily_client

logger = logging.getLogger(__name__)


class FactCheckerV4(CachedAgent):
    ...
    def __init__(self, use_cache: bool = True):
        ...
        """
        super().__init__(name="fact_checker_v4", use_cache=use_cache)
