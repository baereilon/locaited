...
class Workflow:
    ...
    def __init__(self, use_cache: bool = True):
        ...
        self.researcher = ResearcherAgent(use_cache=use_cache)
        self.fact_checker = FactCheckerAgent(use_cache=use_cache)
        self.publisher = PublisherAgent(use_cache=use_cache)
